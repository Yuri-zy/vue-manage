  ...
  <el-row class="home" :gutter="20">
    ...
    <el-col style="margin-top: 20px" :span="16">
      ...
      <el-card style="height: 280px">
        ...
        <e-charts :chartData="echartsData.order" style="height: 280px"></e-charts>
      </el-card>
      <div class="graph">
        <el-card style="height: 260px">
          <!-- <div style="height: 240px" ref="userEcharts"></div> -->
          <e-charts :chartData="echartsData.user" style="height: 240px"></e-charts>
        </el-card>
        <el-card style="height: 260px">
          <!-- <div style="height: 240px" ref="videoEcharts"></div> -->
          <e-charts :chartData="echartsData.video" style="height: 240px"></e-charts>
        </el-card>
      </div>
    </el-col>
  </el-row>
    ...
    getData().then(
      res => {
        ...
        if (code === 20000) {
          ...
          //   ]
          // }
          this.echartsData.user.xData = userData.map(item => item.date)
